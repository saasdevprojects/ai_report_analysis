    ...
    <div className="min-h-screen bg-slate-50 font-plex">
      ...
      <aside className="sticky top-6 h-max rounded-xl border border-slate-200 bg-white p-3">
        <nav className="text-sm">
          <ul className="space-y-1">
            ...
            <li><a href="#segmentation" className="block rounded-md px-2 py-1.5 text-slate-700 hover:bg-slate-100">Segmentation</a></li>
            <li><a href="#audience" className="block rounded-md px-2 py-1.5 text-slate-700 hover:bg-slate-100">Audience</a></li>
            <li><a href="#competition" className="block rounded-md px-2 py-1.5 text-slate-700 hover:bg-slate-100">Competition</a></li>
            <li><a href="#journey" className="block rounded-md px-2 py-1.5 text-slate-700 hover:bg-slate-100">Journey</a></li>
            <li><a href="#regulation" className="block rounded-md px-2 py-1.5 text-slate-700 hover:bg-slate-100">Regulation</a></li>
            <li><a href="#evidence" className="block rounded-md px-2 py-1.5 text-slate-700 hover:bg-slate-100">Evidence</a></li>
            <li><a href="#recap" className="block rounded-md px-2 py-1.5 text-slate-700 hover:bg-slate-100">Recap</a></li>
          </ul>
        </nav>
      </aside>
      <div className="space-y-6">
        <section id="report-guide" className="scroll-mt-24">
          <div className={`${forecastCardClass} p-6`}>
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <a href="#overview" className="group block rounded-lg border border-slate-200 bg-white/95 p-4 text-sm shadow-sm transition hover:border-cyan-200 hover:shadow">
              ...
              <a href="#segmentation" className="group block rounded-lg border border-slate-200 bg-white/95 p-4 text-sm shadow-sm transition hover:border-cyan-200 hover:shadow">
                <h3 className="mb-1 text-sm font-semibold text-cyan-700 group-hover:text-cyan-800">Segmentation</h3>
                <p className="leading-relaxed text-slate-600">{segIndustry.length + segGeography.length + segCustomer.length} segments</p>
              </a>
              <a href="#audience" className="group block rounded-lg border border-slate-200 bg-white/95 p-4 text-sm shadow-sm transition hover:border-cyan-200 hover:shadow">
                <h3 className="mb-1 text-sm font-semibold text-cyan-700 group-hover:text-cyan-800">Audience</h3>
                <p className="leading-relaxed text-slate-600">{personaProfiles.length} personas • {channelUsage.length} channels • {sentimentMaps.length} sentiment maps</p>
              </a>
              <a href="#competition" className="group block rounded-lg border border-slate-200 bg-white/95 p-4 text-sm shadow-sm transition hover:border-cyan-200 hover:shadow">
                <h3 className="mb-1 text-sm font-semibold text-cyan-700 group-hover:text-cyan-800">Competition</h3>
                <p className="leading-relaxed text-slate-600">{competitors.length} competitors • {featureBenchmark.length} features</p>
              </a>
              <a href="#journey" className="group block rounded-lg border border-slate-200 bg-white/95 p-4 text-sm shadow-sm transition hover:border-cyan-200 hover:shadow">
                <h3 className="mb-1 text-sm font-semibold text-cyan-700 group-hover:text-cyan-800">Journey & Growth</h3>
                <p className="leading-relaxed text-slate-600">{journey.length} stages • {growthTimeline.length} periods</p>
              </a>
              <a href="#regulation" className="group block rounded-lg border border-slate-200 bg-white/95 p-4 text-sm shadow-sm transition hover:border-cyan-200 hover:shadow">
              ...
              <a href="#evidence" className="group block rounded-lg border border-slate-200 bg-white/95 p-4 text-sm shadow-sm transition hover:border-cyan-200 hover:shadow">
              ...
              <a href="#recap" className="group block rounded-lg border border-slate-200 bg-white/95 p-4 text-sm shadow-sm transition hover:border-cyan-200 hover:shadow">
        ...
        <section id="overview" className="scroll-mt-24">
          <Card
            className={`${forecastCardClass} p-6`}
        ...
        <section id="competition" className="grid gap-6 lg:auto-rows-fr lg:grid-cols-2 scroll-mt-24">
          <Card
        ...
        <section id="regulation" className="grid gap-6 lg:auto-rows-fr lg:grid-cols-[1.2fr_1fr] scroll-mt-24">
          <Card
        ...
        <section id="recap" className="grid gap-6 scroll-mt-24">
          <Card
