          ...
          <div className="grid gap-14 place-items-center lg:grid-cols-2 lg:items-center">
            <div className="mx-auto max-w-sm space-y-8 text-center lg:mx-0 lg:text-left">
              <div className="space-y-2">
                <h1 className="text-4xl font-semibold text-foreground sm:text-5xl">Login</h1>
                <p className="text-base text-muted-foreground">Select your preferred sign in method.</p>
              </div>
